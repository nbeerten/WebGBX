    ...
    <div class="px-4 mx-auto max-w-7xl lg:px-8">
        <div class="flex items-center h-16 ">
            <div class="flex items-center flex-shrink-0">
                <img class="w-auto h-8 border rounded-full shadow-md border-zinc-700 shadow-black/80" src="{{ asset('storage/logo_plain.svg') }}" alt="WebGBX logo">
                <h1 class="ml-2 text-xl font-bold text-white">WebGBX</h1>
            </div>
            ...
            <div class="flex items-center mx-4 flex-shrink-0 md:absolute md:top-0 md:right-4 md:h-full">
                <a href="https://github.com/nbeerten/WebGBX" target="_blank" class="flex flex-row items-center justify-center gap-x-2 w-full">
