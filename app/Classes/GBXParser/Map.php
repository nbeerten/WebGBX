...
namespace App\Classes\GBXParser;

use App\Classes\GBXParser\Map\Dependency;
use App\Classes\GBXParser\Map\Parser;
use App\Classes\GBXParser\Map\Thumbnail;
...
class Map
{
    ...
    // ADDITION START
    public function getc8_authorLogin()
    {
        return $this->c8_authorLogin;
    }
    public function getc8_authorName()
    {
        return $this->c8_authorName;
    }
    public function getc8_authorZone()
    {
